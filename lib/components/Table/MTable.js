...
var MTable = function (_React$PureComponent) {
  ...
  function MTable(props) {
    ...
    _this.state = {
      height: _this.props.type ? _this.props.height : undefined
    };
    return _this;
  }
    ...
    value: function render() {
      ...
      return _react2.default.createElement(
        ...
        _react2.default.createElement(_table2.default, (0, _extends3.default)({
          ...
          pagination: paginationProps === false || paginationProps ? false :
          // 本地分页
          {
        ...
        // 如果不传分页的Props就用本地的分页
        paginationProps && paginationProps !== false ? _react2.default.createElement(_pagination2.default, (0, _extends3.default)({
          className: type ? 'fixed-pagination' : 'ant-pagination-right',
          showSizeChanger: true,
          showTotal: function showTotal(totalData) {
            return _react2.default.createElement(
...
MTable.propsType = {
  ...
  type: _propTypes2.default.oneOf([undefined, 'max']),
