...
exports.default = function (_ref) {
  ...
  return _react2.default.createElement(
    _form2.default,
    (0, _extends3.default)({ horizontal: true }, others),
    fields.map(function (field) {
      return _react2.default.createElement(
        FormItem,
        (0, _extends3.default)({ label: field.name + ':', help: field.help, hasFeedback: field.hasFeedback === false ? field.hasFeedback : true, key: field.key }, layout),
