...
var enhanceEffects = function enhanceEffects() {
  ...
  function createPutEffect(sagaEffects) {
    ...
    return _regenerator2.default.mark(function putEffect(type, payload) {
      var action,
          _args2 = arguments;
      return _regenerator2.default.wrap(function putEffect$(_context2) {
        while (1) {
          switch (_context2.prev = _context2.next) {
            case 0:
              action = { type: type, payload: payload };

              if (_args2.length === 1 && (typeof type === 'undefined' ? 'undefined' : (0, _typeof3.default)(type)) === 'object') {
                action = _args2[0];
              }
              _context2.next = 4;
              return put(action);
  ...
  function createUpdateEffect(sagaEffects) {
    ...
    return _regenerator2.default.mark(function updateEffect(payload) {
      return _regenerator2.default.wrap(function updateEffect$(_context3) {
        while (1) {
  ...
  function createExtraCall(sagaEffects) {
    ...
    return _regenerator2.default.mark(function extraCallEffect(serviceFn, args) {
      ...
      return _regenerator2.default.wrap(function extraCallEffect$(_context4) {
        while (1) {
          switch (_context4.prev = _context4.next) {
            ...
            case 19:
              ...
              errorMsg && _antd.Modal.error({ title: errorMsg });
              throw _context4.t0;
...
function extend(defaults, properties) {
  ...
  var model = defaults || getDefaultModel();
