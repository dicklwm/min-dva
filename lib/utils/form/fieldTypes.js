...
var fieldTypes = {
  ...
  textarea: function textarea(_ref7) {
    ...
    return _react2.default.createElement(_input2.default, (0, _extends3.default)({ type: 'textarea', rows: meta.rows || 3, placeholder: placeholder, autosize: meta.autosize }, inputProps));
  },
